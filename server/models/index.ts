...
const userSchema = new mongoose.Schema({
  ...
  role: {
    type: String,
    enum: ["admin", "staff", "supervisor", "apollo"],
    required: true,
  },
...
const manualSchema = new mongoose.Schema({
  id: { type: String, required: true, unique: true },
  companyId: { type: String }, // undefined/global when not provided
...
const advertisementSchema = new mongoose.Schema({
  id: { type: String, required: true, unique: true },
  placement: { type: String, enum: ["login", "app"], required: true },
  ...
  companyId: { type: String }, // undefined for global
  startAt: Date,
  endAt: Date,
...
export const Manual = mongoose.models.Manual || mongoose.model("Manual", manualSchema);
