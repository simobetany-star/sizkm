  ...
  const getAvailableForms = () => {
    return forms.filter(
      (f) =>
        ...
        f.isTemplate) &&
        // Only show SAHL and ABSA forms in Job Assigned Forms
        (f.id.includes('sahl') || f.id.includes('absa') || f.name.toLowerCase().includes('sahl') || f.name.toLowerCase().includes('absa'))
    );
  };
